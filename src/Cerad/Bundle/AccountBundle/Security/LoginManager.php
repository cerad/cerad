 ...
 * 
 * Simplify things a bit by allowing null values until I understand things a bit better
 */
class LoginManager implements LoginManagerInterface
{
    ...
    public function __construct(
            SecurityContextInterface               $context,                // Always need
            UserCheckerInterface                   $userChecker     = null, // Generally use UserChecker component
            SessionAuthenticationStrategyInterface $sessionStrategy = null, // Unclear where this comes from
            ContainerInterface                     $container       = null) // Really don't want this
    {
    ...
    {
        if ($this->userChecker) $this->userChecker->checkPostAuth($user);
